...
asmlinkage long mbx421_init(unsigned int ptrs, unsigned int prob);
asmlinkage long mbx421_shutdown(void);
asmlinkage long mbx421_create(unsigned long id);
asmlinkage long mbx421_destroy(unsigned long id);
asmlinkage long mbx421_count(unsigned long id);
asmlinkage long mbx421_send(unsigned long id, const unsigned char __user *msg, long len);
asmlinkage long mbx421_recv(unsigned long id, unsigned char __user *msg, long len);
asmlinkage long mbx421_length(unsigned long id);
asmlinkage long mbx421_acl_add(unsigned long id, pid_t process_id);
asmlinkage long mbx421_acl_remove(unsigned long id, pid_t process_id);
